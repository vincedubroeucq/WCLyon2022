 ...
 */
  ...
  */
 import { useBlockProps, RichText, MediaPlaceholder } from '@wordpress/block-editor';  // Core
 ...
 export default function edit( { attributes, setAttributes } ) {
	...
	if (rounded) imageAttributes.class = 'rounded'; // On ajoute la classe CSS pour l'image uniquement si on en a besoin, pour éviter l'attribut class vide.
				...
				<div className="image">
					...
					:
						<MediaPlaceholder
							...
							allowedTypes={ ['image'] } 
							labels = { { title: __( 'Testimonial image', 'my-awesome-block' ) } }
						/>
					}
				</div>
